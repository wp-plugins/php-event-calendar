<?php
global $table_prefix;
$commands = "CREATE TABLE IF NOT EXISTS `pec_admin_user_cals` (
  `admin_id` int(11) unsigned NOT NULL DEFAULT '0',
  `cal_id` int(11) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`admin_id`,`cal_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;";
// ////////////////////////////////////////////////////////
// ".$table_prefix." adds the wp prefix with pec table names. 
//
// Table structure for table `pec_calendars`
//

$commands .= "CREATE TABLE IF NOT EXISTS `pec_calendars` (
...
$commands .= "CREATE TABLE IF NOT EXISTS `pec_default_reminders` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(11) unsigned DEFAULT NULL,
...
$commands .= "CREATE TABLE IF NOT EXISTS `pec_events` (
...
$commands .= "CREATE TABLE IF NOT EXISTS `pec_event_calendar_settings` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
$commands .= "CREATE TABLE IF NOT EXISTS `pec_guests` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
$commands .= "CREATE TABLE IF NOT EXISTS `pec_mobile_calendar_settings` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned DEFAULT NULL,
...
$commands .= "CREATE TABLE IF NOT EXISTS `pec_reminders` (
...
$commands .= "CREATE TABLE IF NOT EXISTS `pec_settings` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned DEFAULT NULL,
...
$commands .= "CREATE TABLE IF NOT EXISTS `pec_shared_calendars` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `type` enum('user','group','url') DEFAULT 'user',
  `user_id` int(11) unsigned DEFAULT NULL,
  `cal_id` int(11) unsigned DEFAULT NULL,
...
$commands .= "CREATE TABLE IF NOT EXISTS `pec_users` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
$commands .= "CREATE TABLE IF NOT EXISTS `pec_user_permissions` (
  `user_id` int(10) unsigned NOT NULL,
...
$commands .= "CREATE TABLE IF NOT EXISTS `pec_user_share_free_busy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(11) unsigned DEFAULT NULL,
...
//
$commands .= "ALTER TABLE `pec_admin_user_cals`
...
//
$commands .= "ALTER TABLE `pec_calendars`
...
//
$commands .= "ALTER TABLE `pec_default_reminders`
...
//
$commands .= "ALTER TABLE `pec_event_calendar_settings`
...
//
$commands .= "ALTER TABLE `pec_guests`
...
//
$commands .= "ALTER TABLE `pec_mobile_calendar_settings`
...
//
$commands .= "ALTER TABLE `pec_reminders`
...
//
$commands .= "ALTER TABLE `pec_user_permissions`
...
//
$commands .= "ALTER TABLE `pec_user_share_free_busy`
