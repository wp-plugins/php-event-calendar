...
*/
    ...
    $wpdb->query($sql);
    */
    $sql = "INSERT INTO `pec_events` (`start_date`, `start_time`, `start_timestamp`, `end_date`, `end_time`, `end_timestamp`, `title`, `description`, `allDay`, `created_on`, `updated_on`)
    VALUES ('$start_date', '$start_time', '$start_timestamp', '$end_date', '$end_time', '$end_timestamp', '$summary', '$description', '$allDay', '$created_date', '$modify_date');";
